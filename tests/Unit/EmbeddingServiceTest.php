...
class EmbeddingServiceTest extends TestCase
{
    ...
    public function test_normalize_vector_and_dot_product_and_equality(): void
    {
        $svc = new class extends EmbeddingService {
            public function exposeNormalize(array $v) { return $this->normalizeVector($v); }
            public function exposeDot(array $a, array $b) { return $this->dotProduct($a, $b); }
            public function exposeEqual(array $a, array $b, float $eps = 1e-6) { return $this->vectorsEqual($a, $b, $eps); }
        };
